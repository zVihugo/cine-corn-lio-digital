        ...
        <div className="max-w-2xl pt-20">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <Badge variant={getAgeBadgeVariant(currentMovie.ageRating)} className="text-sm px-3 py-1">
                {currentMovie.ageRating === "L" ? "Livre" : `${currentMovie.ageRating}+`}
              </Badge>
            ...
            <div className="mt-8 flex items-center gap-2 flex-wrap">
              <span className="text-sm text-muted-foreground mr-2">Hoje:</span>
